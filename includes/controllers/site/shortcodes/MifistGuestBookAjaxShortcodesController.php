    ...
    implements MifistICreatorInstance
{
    ...
    public function initShortcode()
    {
        ...
        /*
         * Добавляем щорткод [mifist_ajax_guest_book]
         * этот шорткод будет добалять форму для добавления данных в гостевую книгу
         */
        add_shortcode( 'mifist_ajax_guest_book', array(&$this, 'action'));
    }
    ...
    public function render($data)
    {
	    ...
	    $pathView = MIFISTSLICK_PlUGIN_DIR . '/includes/views/site/shortcodes/MifistGuestBookAjaxShortcodes.view.php';
